...
def get_data(input_path):
	'''
	returns
	all_imgs- annotation data of all images like object, bbox, file_path etc.
	classes_count- dictionary indicating total count of each class
	class_mapping- dictionary indicating class index
	'''
	all_imgs = []
	classes_count = {}
	class_mapping = {}
